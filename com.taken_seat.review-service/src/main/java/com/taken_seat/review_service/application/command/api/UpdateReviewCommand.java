...
public class UpdateReviewCommand implements ReviewCommand<ReviewDetailResDto> {

	private final ReviewService reviewService;
	private final ReviewDto reviewDto;

	public UpdateReviewCommand(ReviewService reviewService, ReviewDto reviewDto) {
