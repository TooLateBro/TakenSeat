...
public interface UserControllerDocs {
    ...
    ResponseEntity<ApiResponseData<UserInfoResponseDto>> getUser(@PathVariable UUID userId, AuthenticatedUser authenticatedUser);
    ...
    ResponseEntity<ApiResponseData<String>> getCoupon(@PathVariable UUID couponId,AuthenticatedUser authenticatedUser);
